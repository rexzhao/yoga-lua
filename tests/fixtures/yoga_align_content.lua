...
return {
  ...
  stretch_row("align_content_stretch_row_with_children", {
    {
      style = { width = 50 },
      children = {
        { style = { flexGrow = 1, flexShrink = 1, flexBasis = "0%" } },
  ...
  stretch_row("align_content_stretch_row_with_flex", {
    { style = { width = 50 } },
    { style = { width = 50, flexGrow = 1, flexShrink = 1, flexBasis = "0%" } },
    { style = { width = 50 } },
    { style = { width = 50, flexGrow = 1, flexShrink = 1, flexBasis = "0%" } },
    ...
    { left = 100, top = 0, width = 50, height = 100 },
  }),
  stretch_row("align_content_stretch_row_with_flex_no_shrink", {
    { style = { width = 50 } },
    { style = { width = 50, flexGrow = 1, flexShrink = 1, flexBasis = "0%" } },
    { style = { width = 50 } },
    { style = { width = 50, flexGrow = 1, flexBasis = "0%" } },
